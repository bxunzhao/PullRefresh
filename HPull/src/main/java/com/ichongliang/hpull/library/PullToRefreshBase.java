 ...
 *******************************************************************************/
package com.ichongliang.hpull.library;
...
import com.ichongliang.hpull.R;


public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements com.ichongliang.hpull.library.IPullToRefresh<T> {
	...
	private com.ichongliang.hpull.library.internal.LoadingLayout mHeaderLayout;
	private com.ichongliang.hpull.library.internal.LoadingLayout mFooterLayout;
	...
	@Override
	public final com.ichongliang.hpull.library.ILoadingLayout getLoadingLayoutProxy(boolean includeStart, boolean includeEnd) {
	...
	public final boolean isPullToRefreshOverScrollEnabled() {
		return VERSION.SDK_INT >= VERSION_CODES.GINGERBREAD && mOverScrollEnabled
				&& com.ichongliang.hpull.library.OverscrollHelper.isAndroidOverScrollEnabled(mRefreshableView);
	}
	...
	protected com.ichongliang.hpull.library.internal.LoadingLayout createLoadingLayout(Context context, Mode mode, TypedArray attrs) {
		com.ichongliang.hpull.library.internal.LoadingLayout layout = mLoadingAnimationStyle.createLoadingLayout(context, mode,
	 ...
	 */
	protected com.ichongliang.hpull.library.LoadingLayoutProxy createLoadingLayoutProxy(final boolean includeStart, final boolean includeEnd) {
		com.ichongliang.hpull.library.LoadingLayoutProxy proxy = new com.ichongliang.hpull.library.LoadingLayoutProxy();
	...
	protected final com.ichongliang.hpull.library.internal.LoadingLayout getFooterLayout() {
	...
	protected final com.ichongliang.hpull.library.internal.LoadingLayout getHeaderLayout() {
	...
	protected final void setHeaderScroll(int value) {
		...
		if (USE_HW_LAYERS) {
			 ...
			 */
			com.ichongliang.hpull.library.internal.ViewCompat.setLayerType(mRefreshableViewWrapper, value != 0 ? View.LAYER_TYPE_HARDWARE
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (a.hasValue(R.styleable.PullToRefresh_ptrRefreshableViewBackground)) {
			...
			com.ichongliang.hpull.library.internal.Utils.warnDeprecation("ptrAdapterViewBackground", "ptrRefreshableViewBackground");
	...
	public static enum AnimationStyle {
		...
		com.ichongliang.hpull.library.internal.LoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
			switch (this) {
				case ROTATE:
				default:
					return new com.ichongliang.hpull.library.internal.RotateLoadingLayout(context, mode, scrollDirection, attrs);
				case FLIP:
					return new com.ichongliang.hpull.library.internal.FlipLoadingLayout(context, mode, scrollDirection, attrs);
			}
		}
	}
	 ...
	 * {@link com.ichongliang.hpull.library.PullToRefreshAdapterViewBase#setOnLastItemVisibleListener}.
	 *
	 * @author Chris Banes
	 */
	 ...
	 * (such as sounds). See (
	 * {@link com.ichongliang.hpull.library.PullToRefreshAdapterViewBase#setOnPullEventListener}.
	 *
	 * @author Chris Banes
	 */
	...
	final class SmoothScrollRunnable implements Runnable {
		...
		public void run() {
			...
			if (mContinueRunning && mScrollToY != mCurrentY) {
				com.ichongliang.hpull.library.internal.ViewCompat.postOnAnimation(PullToRefreshBase.this, this);
			} else {
				if (null != mListener) {
