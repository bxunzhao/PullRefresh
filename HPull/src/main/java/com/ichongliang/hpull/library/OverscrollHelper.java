...
public final class OverscrollHelper {
	 ...
	 */
	public static void overScrollBy(final com.ichongliang.hpull.library.PullToRefreshBase<?> view, final int deltaX, final int scrollX,
	...
	public static void overScrollBy(final com.ichongliang.hpull.library.PullToRefreshBase<?> view, final int deltaX, final int scrollX,
		...
		if (view.isPullToRefreshOverScrollEnabled() && !view.isRefreshing()) {
			...
			if (mode.permitsPullToRefresh() && !isTouchEvent && deltaValue != 0) {
				...
				if (com.ichongliang.hpull.library.PullToRefreshBase.DEBUG) {
